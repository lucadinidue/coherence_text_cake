...
def main():
    ...
    out_dir = f'../models/{model_str}/train_{args.language}_{args.dataset}_test_{args.language}_{args.dataset}'
    ...
    def compute_metrics(p):
        ...
        cm_disp.plot(cmap='Blues', xticks_rotation='vertical').figure_.savefig(os.path.join(predictions_dir, 'confusion_matrix.png'), bbox_inches='tight')
        return result
